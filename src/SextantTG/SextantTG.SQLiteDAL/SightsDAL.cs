...
namespace SextantTG.SQLiteDAL
{
    public class SightsDAL : ISightsDAL
    {
        ...
        private Sights BuildSightsByReader(DbDataReader r)
        {
            ...
            sights.Price = TypeConverter.ToString(r["price"]);
        ...
        public List<Sights> GetSightsBySightsId(string SightsId)
        {
            List<Sights> sights = new List<Sights>();
        ...
        public Sights GetSightsById(string SightsId)
        {
            Sights sights = null;
            Dictionary<string, object> pars = new Dictionary<string, object>();
            pars.Add("SightsId", sightsId);
        ...
        public int DeleteSightsById(string SightsId, DbTransaction trans)
        {
            Dictionary<string, object> pars = new Dictionary<string, object>();
            pars.Add("SightsId", sightsId);
